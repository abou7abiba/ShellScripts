...
ALTER TABLE db2admin.LSW_SYSTEM ADD CONSTRAINT "NAME" CHECK (CHARACTER_LENGTH("NAME",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION
...
ALTER TABLE db2admin.LSW_TRACKING_POINT ADD CONSTRAINT "NAME" CHECK (CHARACTER_LENGTH("NAME",CODEUNITS16) <= 600)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_TRACKING_POINT ADD CONSTRAINT "TYPE" CHECK (CHARACTER_LENGTH("TYPE",CODEUNITS16) <= 50)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_TRACKING_POINT ADD CONSTRAINT "LOCAL_PROCESS_GUID" CHECK (CHARACTER_LENGTH("LOCAL_PROCESS_GUID",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_TRACKING_POINT ADD CONSTRAINT "PROCESS_ITEM_ID" CHECK (CHARACTER_LENGTH("PROCESS_ITEM_ID",CODEUNITS16) <= 100)  ENFORCED ENABLE QUERY OPTIMIZATION
...
ALTER TABLE db2admin.LSW_TRACKED_FIELD ADD CONSTRAINT "EXTERNAL_UNIQUE_ID" CHECK (CHARACTER_LENGTH("EXTERNAL_UNIQUE_ID",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_TRACKED_FIELD ADD CONSTRAINT "NAME" CHECK (CHARACTER_LENGTH("NAME",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION
...
ALTER TABLE db2admin.LSW_TIMING_INTERVAL ADD CONSTRAINT "NAME" CHECK (CHARACTER_LENGTH("NAME",CODEUNITS16) <= 800)  ENFORCED ENABLE QUERY OPTIMIZATION
...
ALTER TABLE db2admin.LSW_TASK ADD CONSTRAINT "SYSTEM_USER_ID" CHECK (CHARACTER_LENGTH("SYSTEM_USER_ID",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_TASK ADD CONSTRAINT "SYSTEM_TASK_ID" CHECK (CHARACTER_LENGTH("SYSTEM_TASK_ID",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_TASK ADD CONSTRAINT "SYSTEM_FUNCTIONAL_TASK_ID" CHECK (CHARACTER_LENGTH("SYSTEM_FUNCTIONAL_TASK_ID",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_TASK ADD CONSTRAINT "BPD_NAME" CHECK (CHARACTER_LENGTH("BPD_NAME",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_TASK ADD CONSTRAINT "STARTING_PROCESS_ID" CHECK (CHARACTER_LENGTH("STARTING_PROCESS_ID",CODEUNITS16) <= 2000)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_TASK ADD CONSTRAINT "ACTIVITY_NAME" CHECK (CHARACTER_LENGTH("ACTIVITY_NAME",CODEUNITS16) <= 580)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_TASK ADD CONSTRAINT "CREATED_BY_PROCESS_ITEM_ID" CHECK (CHARACTER_LENGTH("CREATED_BY_PROCESS_ITEM_ID",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_TASK ADD CONSTRAINT "ASSIGNED_GROUP_ID" CHECK (CHARACTER_LENGTH("ASSIGNED_GROUP_ID",CODEUNITS16) <= 261)  ENFORCED ENABLE QUERY OPTIMIZATION
...
ALTER TABLE db2admin.LSW_PRI_KEY ADD CONSTRAINT "TABLE_ID" CHECK (CHARACTER_LENGTH("TABLE_ID",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION
...
ALTER TABLE db2admin.LSW_LOAD_TRACE ADD CONSTRAINT "SYNCHRONIZATION_EUID" CHECK (CHARACTER_LENGTH("SYNCHRONIZATION_EUID",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION
...
ALTER TABLE db2admin.LSW_VIEW ADD CONSTRAINT "NAME" CHECK (CHARACTER_LENGTH("NAME",CODEUNITS16) <= 100)  ENFORCED ENABLE QUERY OPTIMIZATION
...
ALTER TABLE db2admin.LSW_DATA_TRANSFER_ERRORS ADD CONSTRAINT "DATA_TRANSFER_ERRORS_ID" CHECK (CHARACTER_LENGTH("DATA_TRANSFER_ERRORS_ID",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_DATA_TRANSFER_ERRORS ADD CONSTRAINT "CLAIMED_BY" CHECK (CHARACTER_LENGTH("CLAIMED_BY",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION
...
ALTER TABLE db2admin.LSW_OPTIMIZER_DATA ADD CONSTRAINT "STRING_VALUE" CHECK (CHARACTER_LENGTH("STRING_VALUE",CODEUNITS16) <= 255)  ENFORCED ENABLE QUERY OPTIMIZATION
...
ALTER TABLE db2admin.LSW_USER_MAPPINGS ADD CONSTRAINT "USERNAME" CHECK (CHARACTER_LENGTH("USERNAME",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION
...
ALTER TABLE db2admin.LSW_TABLE ADD CONSTRAINT "TRACKING_GROUP_NAME" CHECK (CHARACTER_LENGTH("TRACKING_GROUP_NAME",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_TABLE ADD CONSTRAINT "EXTERNAL_UNIQUE_ID" CHECK (CHARACTER_LENGTH("EXTERNAL_UNIQUE_ID",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_TABLE ADD CONSTRAINT "TABLE_NAME" CHECK (CHARACTER_LENGTH("TABLE_NAME",CODEUNITS16) <= 100)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_TABLE ADD CONSTRAINT "NEW_TABLE_NAME" CHECK (CHARACTER_LENGTH("NEW_TABLE_NAME",CODEUNITS16) <= 100)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_TABLE ADD CONSTRAINT "NEW_CONSTR_PREFIX" CHECK (CHARACTER_LENGTH("NEW_CONSTR_PREFIX",CODEUNITS16) <= 14)  ENFORCED ENABLE QUERY OPTIMIZATION
...
ALTER TABLE db2admin.LSW_COLUMN ADD CONSTRAINT "TRACKED_FIELD_NAME" CHECK (CHARACTER_LENGTH("TRACKED_FIELD_NAME",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_COLUMN ADD CONSTRAINT "EXTERNAL_UNIQUE_ID" CHECK (CHARACTER_LENGTH("EXTERNAL_UNIQUE_ID",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_COLUMN ADD CONSTRAINT "COLUMN_NAME" CHECK (CHARACTER_LENGTH("COLUMN_NAME",CODEUNITS16) <= 100)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_COLUMN ADD CONSTRAINT "NEW_COLUMN_NAME" CHECK (CHARACTER_LENGTH("NEW_COLUMN_NAME",CODEUNITS16) <= 100)  ENFORCED ENABLE QUERY OPTIMIZATION
...
ALTER TABLE db2admin.LSW_SNAPSHOT ADD CONSTRAINT "NAME" CHECK (CHARACTER_LENGTH("NAME",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION

;


ALTER TABLE db2admin.LSW_SNAPSHOT ADD CONSTRAINT "SHORT_NAME" CHECK (CHARACTER_LENGTH("SHORT_NAME",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION
